...
public class Gui_KetCa extends VBox {
    ...
    public void loadDuLieuCa() {
        try {
            ...
            caHienTai = caDAO.getCaDangLam(maNhanVien);
            ...
            int soLuongHD = caDAO.demSoHoaDonTrongCa(maNhanVien, caHienTai.getThoiGianVaoCa());
            txtTongSoHoaDon.setText(String.valueOf(soLuongHD));
            txtGiamGia.setText(formatMoney(caDAO.tinhTongTienGiamGia(maNhanVien, caHienTai.getThoiGianVaoCa())));
            txtTienMat.setText(formatMoney(caDAO.tinhTongTienMat(maNhanVien, caHienTai.getThoiGianVaoCa())));
            txtNganHang.setText(formatMoney(0));
            txtDangPhucVu.setText(String.valueOf(caDAO.demDonDangPhucVu(maNhanVien, caHienTai.getThoiGianVaoCa())));
...
//    + tienCoc
    ...
    private void xuLyKetCa(Button btn) {
        ...
        try {
            ...
            Ca_DAO caDAO = new Ca_DAO();
            boolean success = caDAO.ketCa(caHienTai.getMaCa(), tienCuoiCa);
