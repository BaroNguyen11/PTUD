...
public class Gui_QuanLiKhuyenMai extends Application {
	// DANH SÁCH TOÀN CỤC
	...
	public void start(Stage primaryStage) {
		...
		///Phan ben trai
		VBox vboxBenTrai = taoPhanBenTrai();
		root.setCenter(vboxBenTrai);
		
		//Ben phai
		VBox hboxBenPhai = taoPhanBenPhai();
		hboxBenPhai.setPrefWidth(600);
		root.setRight(hboxBenPhai);
