...
public class SideBar extends VBox {
    ...
    private HBox createMenuItem(String text, String iconFileName) {
        ImageView icon = createImageView("/img/" + iconFileName, 18, 18);
    ...
    private void handleMenuClick(String menuText, HBox clickedItem) {
        ...
        Platform.runLater(() -> {
        	switch (menuText) {
	            case "Dashboard" -> trangChu.setMainContent(new Label("..."));
	            case "Quản lí món ăn" -> trangChu.setMainContent(new Label("Giao diện Quản lí món ăn"));
	            case "Thống kê" -> trangChu.setMainContent(new Label("..."));
	            case "Kết ca" -> trangChu.setMainContent(new Label("..."));
	            case "Quản lí khách hàng" -> trangChu.setMainContent(new Label("..."));
	            case "Quản lí nhân viên" -> trangChu.setMainContent(new Label("..."));
	            case "Thanh toán" -> trangChu.setMainContent(new Label("..."));
	            case "Quản lí khuyến mãi" -> trangChu.setMainContent(new Label("..."));
	            case "Quản lí hóa đơn" -> trangChu.setMainContent(new Label("..."));
...
//        }
    ...
    private void handleSubmenuClick(String subMenuText, HBox clickedItem) {
        ...
        Platform.runLater(() -> {
          ...
          case "Đổi bàn" -> trangChu.setMainContent(new Label("..."));
          case "Hủy bàn" -> trangChu.setMainContent(new Label("..."));
          case "Check-in" -> trangChu.setMainContent(new Label("..."));
          default -> trangChu.setMainContent(new Label("Submenu " + subMenuText));
      }
        });
        
//        switch (subMenuText) {
//            case "Đặt bàn" -> trangChu.setMainContent(new DanhSachBan_Gui(trangChu));
//            case "Đổi bàn" -> trangChu.setMainContent(new Label("..."));
//            case "Hủy bàn" -> trangChu.setMainContent(new Label("..."));
//            case "Check-in" -> trangChu.setMainContent(new Label("..."));
//            default -> trangChu.setMainContent(new Label("Submenu " + subMenuText));
