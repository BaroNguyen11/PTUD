...
public class PhieuDatBanRemoteImpl extends UnicastRemoteObject implements PhieuDatBanRemote {
    ...
    public boolean huyPhieuDatBanByMaPhieu(String maPhieu) throws RemoteException { return RemoteCallLogger.log("PhieuDatBanRemoteImpl", "huyPhieuDatBanByMaPhieu", new Object[]{maPhieu}, () -> dao.huyPhieuDatBanByMaPhieu(maPhieu)); }
}
