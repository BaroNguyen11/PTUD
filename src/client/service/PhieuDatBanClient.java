...
public class PhieuDatBanClient {
    ...
    public boolean kiemTraBanDaDatTrongNgay(String maBan, LocalDateTime thoiGianBatDau, LocalDateTime thoiGianKetThuc) { try { return RemoteServices.phieuDatBan().kiemTraBanDaDatTrongNgay(maBan, thoiGianBatDau, thoiGianKetThuc); } catch (Exception e) { throw new RuntimeException(e); } }
    ...
    public List<PhieuDatBan> getDanhSachPhieuDatBanByMaBanVaNgay(String maBan, LocalDate ngayDat) { try { return RemoteServices.phieuDatBan().getDanhSachPhieuDatBanByMaBanVaNgay(maBan, ngayDat); } catch (Exception e) { throw new RuntimeException(e); } }
