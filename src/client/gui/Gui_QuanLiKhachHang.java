...
public class Gui_QuanLiKhachHang extends BorderPane {
    ...
    private final KhachHangClient khachHangClient = new KhachHangClient();
    ...
    private void loadDataFromDatabase() {
        data.clear();
        data.addAll(khachHangClient.getAllKhachHang());
    }
    ...
    private void applyFilters() {
        ...
        java.util.List<KhachHang> allCustomers = khachHangClient.getAllKhachHang();
    ...
    private GridPane createCustomerForm(KhachHang kh) {
        ...
        String maKhachHang = kh == null ? khachHangClient.taoMaKhachHangMoi() : kh.getMaKhachHang();
        ...
        btnSave.setOnAction(e -> {
            ...
            try {
                if (kh == null) {
                    ...
                    // Kiểm tra trùng SĐT
                    if (khachHangClient.isSoDienThoaiExists(sdt)) {
                    ...
                    // Gọi hàm tạo mã theo ngày mà bạn vừa thêm vào service
                    String newMa = khachHangClient.taoMaKhachHangMoi();

                    // Tạo đối tượng với mã vừa sinh ra
                    KhachHang newKh = new KhachHang(newMa, ten, sdt, 0);

                    // Gọi hàm service để lưu (Hàm addKhachHang trong service chỉ cần INSERT là đủ)
                    if (khachHangClient.addKhachHang(newKh)) {
                    ...
                    if (khachHangClient.isSoDienThoaiExistsForOther(sdt, maCu)) {
                    ...
                    if (khachHangClient.updateKhachHang(kh)) {
