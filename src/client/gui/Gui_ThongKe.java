...
public class Gui_ThongKe extends VBox {
    ...
    private VBox createBookingSection() {
        ...
        // (Giả sử controller đã có các hàm này, nếu chưa bạn cần thêm vào service/Ctrl)
...
//    }
    ...
    private VBox createTopSellingMenuChart() {
        ...
        // Giả sử thongKeCtrl đã có hàm gọi xuống service: return thongKeClient.getTopMonAnBanChay();
