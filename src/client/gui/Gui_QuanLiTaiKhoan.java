...
import client.service.TaiKhoanClient;
...
public class Gui_QuanLiTaiKhoan extends BorderPane {
    ...
    private final TaiKhoanClient taiKhoanClient = new TaiKhoanClient();
    ...
    private void showModalCapTaiKhoan() {
        ...
        // Load danh sách nhân viên chưa có TK từ service
        List<NhanVien> listNV = taiKhoanClient.getNhanVienChuaCoTaiKhoan();
        ...
        btnSave.setOnAction(e -> {
            ...
            if (taiKhoanClient.checkTaiKhoanTonTai(username)) {
            ...
            String maAuto = taiKhoanClient.tuDongLayMaMoi();
            ...
            if (taiKhoanClient.createTaiKhoan(tkMoi)) {
    ...
    private void loadDataFromDatabase() {
        data.clear();
        data.addAll(taiKhoanClient.getAllTaiKhoan());
    }
    ...
    private void applyFilters() {
        ...
        if (!searchKeyword.isEmpty()) {
            filteredTaiKhoan = taiKhoanClient.searchTaiKhoan(searchKeyword);
        } else {
            filteredTaiKhoan = taiKhoanClient.getAllTaiKhoan();
        }
    ...
    private void showModalXacNhan(TaiKhoan tk, boolean khoa) {
        ...
        btnYes.setOnAction(e -> {
            if (taiKhoanClient.updateTrangThaiTaiKhoan(tk.getMaTaiKhoan(), !khoa)) {
    ...
    private void showModalTaoMatKhau(TaiKhoan tk) {
        ...
        btnYes.setOnAction(e -> {
            ...
            if (taiKhoanClient.resetMatKhau(tk.getMaTaiKhoan(), matKhauMaHoa)) {
