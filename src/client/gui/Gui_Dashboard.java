...
import client.service.DashboardClient;
...
public class Gui_Dashboard extends BorderPane {
    ...
    private GridPane createQuickStats() {
        ...
        double doanhThuHomNay = dashboardClient.getTongDoanhThuHomNay();
        double doanhThuHomQua = dashboardClient.getTongDoanhThuHomQua();
        String doanhThuChange = dashboardClient.tinhPhanTramThayDoi(doanhThuHomNay, doanhThuHomQua);

        int luotDatBanHomNay = dashboardClient.getLuotDatBanHomNay();
        int luotDatBanHomQua = dashboardClient.getLuotDatBanHomQua();
        String datBanChange = dashboardClient.tinhPhanTramThayDoi(luotDatBanHomNay, luotDatBanHomQua);

        int monBanRaHomNay = dashboardClient.getSoMonBanRaHomNay();
        int monBanRaHomQua = dashboardClient.getSoMonBanRaHomQua();
        String monBanChange = dashboardClient.tinhPhanTramThayDoi(monBanRaHomNay, monBanRaHomQua);

        int khachHomNay = dashboardClient.getSoKhachPhucVuHomNay();
        int khachHomQua = dashboardClient.getSoKhachPhucVuHomQua();
        String khachChange = dashboardClient.tinhPhanTramThayDoi(khachHomNay, khachHomQua);
    ...
    private VBox createRevenueChartBox() {
        ...
        Runnable updateChart = () -> {
            ...
            switch (cbo.getValue()) {
                case "Hôm nay" -> data = dashboardClient.getDoanhThuHomNayTheoGio();
                case "Tháng này" -> data = dashboardClient.getDoanhThuTheoThang();
                default -> data = dashboardClient.getDoanhThuTheoTuan();
            }
    ...
    private VBox createBestSellerChartBox() {
        ...
        Runnable updateChart = () -> {
            ...
            switch (cbo.getValue()) {
                case "Hôm nay" -> data = dashboardClient.getTopMonBanChayHomNay(fixedLimit);
                case "Tháng này" -> data = dashboardClient.getTopMonBanChayTheoThang(fixedLimit);
                default -> data = dashboardClient.getTopMonBanChay(fixedLimit);
            }
    ...
    private VBox createCustomerTimeChartBox() {
        ...
        XYChart.Series<String, Number> series = new XYChart.Series<>();
        Map<String, Integer> khachData = dashboardClient.getLuongKhachTheoKhungGio();
