...
//
//        // Tên người dùng
//        DangNhapClient user = new DangNhapClient();
...
//    }
    ...
    private void showChangePasswordModal() {
        ...
        btnSave.setOnAction(e -> {
            ...
            String currentHashInDB = taiKhoanClient.getMatKhauByMaNV(nhanVienDangDung.getMaNhanVien());
            ...
            if (taiKhoanClient.updateMatKhau(nhanVienDangDung.getMaNhanVien(), newPassHash)) {
